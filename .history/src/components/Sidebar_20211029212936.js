import { Apps, Bookmark, Comment, Create, Drafts, ExpandLess, FiberManualRecord, FileCopy, Inbox, People } from "@material-ui/icons";
...
export const Sidebar = () => {
  return (
    <SidebarContainer>
      ...
      <SidebarOption Icon = {ExpandLess} title='Threads'/>
    </SidebarContainer>
  );
};
